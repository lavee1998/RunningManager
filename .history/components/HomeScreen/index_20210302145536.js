...
const HomeScreen = () => {
  ...
  const runTypeList = [
    { value: 0, label: "Run based on time and distance", detail: "Detail1"},
    { value: 1, label: "Run based on time", detail: "Detail2" },
    { value: 2, label: "Run based on distance", detail: "Detail3" },
    { value: 3, label: "Free run", detail: "Detail4" },
  ];
      ...
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <Card>
          ...
          <Card.Content>
            ...
            />
            <View>
              <Text>{runTypeList[runType].detail}</Text>
            </View>
