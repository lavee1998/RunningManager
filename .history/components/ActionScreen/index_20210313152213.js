...
const ActionScreen = ({ navigation }) => {
  ...
  const [runCoordinates, setCoordinates]
  ...
  useEffect(() => {
    (async () => {
      ...
      Location.watchPositionAsync({ accuracy: 6, timeInterval: 3, distanceInterval: 1} , updatePosition)
    })();
  }, []);
...
setLocation(location)
  ...
  TaskManager.defineTask(updateTask, ({ data, error }) => {
    if (error) {
