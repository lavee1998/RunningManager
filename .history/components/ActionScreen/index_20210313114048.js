...
const ActionScreen = ({ navigation }) => {
  ...
  TaskManager.defineTask(updateTask, ({ data: { locations }, error }) => {
    if (error) {
  ...
  onPress = async () => {
    ...
    if (status === 'granted') {
      await Location.startLocationUpdatesAsync(updateTask, {
        ...
        <Text>Enable background location</Text>
            ...
            />
             ...
             <Grid style={styles.paddingMarginZero}>
              <Row style={styles.paddingMarginZero}>
                <Col  style={styles.paddingMarginZero}><Text style={styles.primaryDataText}>Average Speed</Text></Col>
                <Col style={styles.paddingMarginZero}><Text style={styles.secondaryDataText} >{averageSpeed} km/h</Text></Col>
              </Row>
              <Row style={styles.paddingMarginZero}>
                <Col style={styles.paddingMarginZero} ><Text style={styles.secondaryDataText} >Distance</Text></Col>
                <Col style={styles.paddingMarginZero}><Text style={styles.primaryDataText}>{distance} km</Text></Col>
              </Row>
            </Grid> 
          </SafeAreaView>
        </ScrollView>
