      ...
      {isCompleted && (
        <ScrollView>
          <SafeAreaView style={styles.contentContainer}>
            ...
            <Grid>
              <Row>
                <Col style={styles.primaryDataContainer}><Text style={styles.primaryDataText}>Average Speed</Text></Col>
                <Col style={styles.secondaryDataContainer}><Text style={styles.primaryDataText}s>{averageSpeed} km/h</Text></Col>
              </Row>
              <Row>
                <Col ><Text >Distance</Text></Col>
                <Col><Text>{distance} km</Text></Col>
              </Row>
            </Grid>
          </SafeAreaView>
        </ScrollView>
...
const styles = StyleSheet.create({
  ...
  primaryDataText: {
    backgroundColor: "white",backgroundColor: "#333333",
