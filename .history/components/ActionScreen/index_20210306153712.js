      ...
      {isCompleted && (
        <ScrollView>
          <SafeAreaView style={styles.contentContainer}>
            ...
            <Grid>
              <Row>
                <Col style={styles.primaryDataContainer}><Text>Average Speed</Text></Col>
                <Col style={styles.secondaryDataContainer}><Text>{averageSpeed} km/h</Text></Col>
              </Row>
              <Row>
                <Col style={{color: 'red'}}><Text>Distance</Text></Col>
