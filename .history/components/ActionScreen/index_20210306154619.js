      ...
      {isCompleted && (
        <ScrollView>
          <SafeAreaView style={styles.contentContainer}>
            ...
            <Grid style={{padding: 0, margin}}>
              <Row>
                <Col ><Text style={styles.primaryDataText}>Average Speed</Text></Col>
                <Col ><Text style={styles.secondaryDataText} >{averageSpeed} km/h</Text></Col>
              </Row>
              <Row>
                <Col ><Text style={styles.secondaryDataText} >Distance</Text></Col>
                <Col><Text style={styles.primaryDataText}>{distance} km</Text></Col>
              </Row>
            </Grid>
          </SafeAreaView>
        </ScrollView>
